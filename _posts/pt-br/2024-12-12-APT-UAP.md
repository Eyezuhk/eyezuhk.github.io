...
{% include figure.liquid loading="lazy" path="/assets/img/APT-UAP/false-positive-generator.png" class="img-fluid rounded z-depth-1" zoomable=true width="50%" height="50%" %}
